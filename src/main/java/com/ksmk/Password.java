...
public final class Password {
    // Define the com.ksmk.BCrypt workload to use when generating password hashes. 10-31 is a valid value.
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Testing com.ksmk.BCrypt com.ksmk.Password hashing and verification");
